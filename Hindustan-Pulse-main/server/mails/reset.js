    ...
    * {
    ...
    <table id="u_content_heading_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <!--[if mso]><table width="100%"><tr><td><![endif]-->
        <h1 style="margin: 0px; color: #5c84d1; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Playfair Display',serif; font-size: 26px; font-weight: 400;"><span><strong>HindustanTime24</strong></span></h1>
    ...
    <table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="line-height: 140%;"><strong>This link can be used for the next 24 hours. If you don't reset your password within this timeframe, you'll need to request a new password reset link. </strong></p>
      </div>
    ...
    <div align="center">
      <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:37px; v-text-anchor:middle; width:162px;" arcsize="11%"  stroke="f" fillcolor="#5b83d1"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
        <a href="${process.env.CORS_URL}/reset-password/${token}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #5b83d1; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
          <span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Reset My Password</span></span>
        </a>
    ...
    <table id="u_content_text_deprecated_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 160%;"><strong>If you requested a password reset for your account, click the button below to create a new password.</strong></p>
    <p style="font-size: 14px; line-height: 160%;"><strong>For your security, password reset links expire after one day to prevent unauthorized access.</strong></p>
      </div>
    ...
    `)
    // return (`
    //     Verify your account by clicking: 
    //     https://${process.env.CORS_URL}/reset-password/${token}
    // `)
}
